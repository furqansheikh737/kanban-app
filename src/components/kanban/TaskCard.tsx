    ...
    <Draggable draggableId={task.id} index={index}>
      {(provided, snapshot) => (
        <div
          ...
          /* --- FIX: 'group/card' use kiya hai taake hover sirf isi card tak mahdood rahe --- */
          className={`
        ...
        >
          ...
          <div className="flex justify-between items-start mb-1 gap-2">
            {isEditing ? (
              ...
              <h3 
                ...
                className="text-[14px] font-medium text-[#172b4d] leading-snug break-words flex-1 cursor-text"
              >
                {task.title}
              </h3>
            )}
            
            {/* --- FIX: 'group-hover/card' triggers only for THIS card --- */}
            {!isEditing && (
          ...
          <div className="flex items-center justify-between mt-3">
            <div className="flex items-center gap-3 text-[#44546f]">
              <AlignLeft size={14} className="hover:text-[#172b4d]" />
